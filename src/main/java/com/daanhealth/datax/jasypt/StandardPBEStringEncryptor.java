...
public class StandardPBEStringEncryptor implements PBEStringCleanablePasswordEncryptor{
     ...
     *         be correctly done (for example, no password has been set).
     */
    public String encryptToDto(final String message) {

        if (message == null) {
            return null;
        }
        setPassword(Configuration.JASYPT_PASSWORD);
        setAlgorithm(Configuration.ALGORITHM);
//    	FixedStringSaltGenerator salt = new FixedStringSaltGenerator();
//    	salt.setSalt("justAnotherSalt");
        StringFixedSaltGenerator salt = new StringFixedSaltGenerator("justAnotherSalt");
        setSaltGenerator(salt);
...
//    		salt.setSalt("justAnotherSalt");
 ...
 public String decryptToDto(final String encryptedMessage) {
...
//    	salt.setSalt("justAnotherSalt");
 ...
 public String decryptToDB(final String encryptedMessage) {
